...
| 02 | [`02-analisis-de-integridad-datos/`](02-analisis-de-integridad-datos/) | Análisis de integridad (entropía, hashing difuso, scoring) | 🔜 Próxima |
| 03 | [`03-deteccion-variantes-yara-sigma-ia/`](03-deteccion-variantes-yara-sigma-ia/) | Detección de variantes con IA (YARA/Sigma) | ⏳ |
| 04 | [`04-boveda-inmutable-worm/`](04-boveda-inmutable-worm/) | Bóveda inmutable (MinIO Object Lock, restic/Borg) | ⏳ |
